export default {
  ...
  searchInformation: {
    ...
    totalResults: "5360000",
    formattedTotalResults: "5,360,000",
  },
  items: [
    {
    ...
    {
      kind: "customsearch#result",
      title: "Explore Google Earth.",
      htmlTitle: "Explore Google <b>Earth</b>.",
      link: "https://www.google.com/earth/",
      displayLink: "www.google.com",
      snippet: "Grab the helm and go on an adventure in Google Earth.",
      htmlSnippet:
        "Grab the helm and go on an adventure in Google <b>Earth</b>.",
      cacheId: "--OL26E9aF8J",
      formattedUrl: "https://www.google.com/earth/",
      htmlFormattedUrl: "https://www.google.com/<b>earth</b>/",
      pagemap: {
        cse_thumbnail: [
          {
            src: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTjtgzPhW0KOBS_KsIA74c1ulnxEzFk-UkyIAHU_Osp7if1lmKQmSPNUKzb",
            width: "310",
            height: "163",
          },
        ],
        metatags: [
          {
            ...
            "og:type": "website",
            "twitter:card": "summary_large_image",
            "twitter:title": "Explore Google Earth.",
            "og:site_name": "Google Earth",
            "og:title": "Explore Google Earth.",
            "og:description":
              "Grab the helm and go on an adventure in Google Earth.",
            "twitter:creator": "@googleearth",
            "twitter:image":
              "https://www.gstatic.com/earth/social/00_generic_facebook-001.jpg",
            "twitter:image:src":
              "https://www.gstatic.com/earth/social/00_generic_facebook-001.jpg",
            "fb:app_id": "1880334805569927",
            "twitter:site": "@googleearth",
            "twitter:description":
              "Grab the helm and go on an adventure in Google Earth.",
            "og:url": "https://earth.google.com/web/",
          },
        ],
        cse_image: [
          {
    ...
    },
    {
      ...
      htmlSnippet:
        "Find the latest and greatest on the <b>world&#39;s</b> most powerful mobile platform. Browse devices, explore resources and learn about the latest updates.",
    ...
    },
    {
      ...
      htmlSnippet:
        "Not your computer? Use Guest mode to sign in privately. Learn more. Next. Create account. ‪Afrikaans‬. ‪azərbaycan‬. ‪bosanski‬. ‪català‬. ‪Čeština‬.",
      formattedUrl: "https://www.google.com/maps/d/u/0/",
      htmlFormattedUrl: "https://www.google.com/maps/d/u/0/",
      pagemap: {
        metatags: [
          {
            viewport: "width=device-width, initial-scale=1",
